...
exports.points = exports.relation = exports.measurement = exports.entity = void 0;
...
function transform(query = {}, map) {
  ...
  return _queryString().default.stringify(_objectSpread(_objectSpread({}, (0, _mapKeys().default)(restQuery, (value, key) => {
