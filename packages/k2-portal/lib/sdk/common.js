...
function _getInstance() {
  _getInstance = _asyncToGenerator(function* (entityName, query) {
    return _sdk().api.dataService.get(`/data/namespaces/{namespace_name}/entity_types/${entityName}/entities?${(0, transformQuery.default)(query, transformQuery.entity)}`);
  });
  return _getInstance.apply(this, arguments);
}
...
function _getRelation() {
  _getRelation = _asyncToGenerator(function* (entityName, query) {
    return _sdk().api.dataService.get(`/data/namespaces/{namespace_name}/entity_types/${entityName}/entities_via_relation_types?${(0, transformQuery.default)(query, transformQuery.relation)}`);
  });
  return _getRelation.apply(this, arguments);
}
